...
<%@ page import="com.bean.group_information" %>
...
<div id = "frame2" class = "fra">
    <div id = "component2" class = "comp" >
        <div id = "addTitle">
            <div id = "addTitle1">&nbsp &nbsp &nbsp 加入群聊</div>
            <button id = "addBack" class = "butt" onclick = "window.location.href='../relationshipList/refresh'" type = "button">
                ×
            </button>
        </div>
        <form id = "addSearch" action = "/ChatSystem/groupAdd/search" method = "get">
            <input type="text" name="target" placeholder="输入查找的群号/群名">
            ...
            <table id = "view1" border = "0" cellpadding = "0" cellspacing = "0">
                ...
                <%
                    ...
                    for(int i = 0; i < list1.size(); i++) {
                        group_information userInformation = (group_information) list1.get(i);
                        int groupId = userInformation.getGroupId();
                        request.setAttribute("groupId", groupId);
                %>
                <tr>
                    <td><%=userInformation.getGroupId()%></td>
                    <td><%=userInformation.getGroupName()%></td>
                    <td>
                        <a class = "able" href="/ChatSystem/groupAdd/send?groupId=${groupId}" >加入</a>
                    </td>
                </tr>
                <%
                    }

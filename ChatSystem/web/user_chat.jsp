...
<body onload="roll()">
    ...
    <div id = "frame2" class = "fra">
        <div id = "component2" class = "comp" >
            ...
            <div id = "sendDiv">
                <form id = "sendForm" action = "/ChatSystem/chat/send" method = "get">
            ...
            <button id = "openHistory" onclick = "window.location.href='../userHistory/refresh?id=${requestScope.id}&name=${requestScope.name}'" type = "button">
                历史
            </button>
        </div>
    </div>

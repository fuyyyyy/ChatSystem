...
<head>
    <meta charset="UTF-8">
    <title>${requestScope.groupName}的聊天记录</title>
...
<div id = "frame2" class = "fra">
    <div id = "component2" class = "comp" >
        <div id = "chatTitle">
            ...
            <button id = "chatBack" class = "butt" onclick = "window.location.href='../groupChat/refresh?groupId=${requestScope.groupId}&groupName=${requestScope.groupName}'" type = "button">
                ×
            </button>
        </div>

        <form id = "historySearch" action = "/ChatSystem/groupHistory/search" method = "get">
            <input type = "text" name = "target" placeholder = "输入查找的聊天内容/用户昵称">
